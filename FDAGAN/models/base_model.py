...
class ModelsFactory(object):
    ...
    def get_by_name(model_name, *args, **kwargs):
        ...
        if model_name == "motiontrans":
            from .motiontrans import Motiontrans
            model = Motiontrans(*args, **kwargs)

        elif model_name == "swapper":
            from .motiontrans import Swapper
            model = Swapper(*args, **kwargs)

        elif model_name == "viewer":
            from .motiontrans import Viewer
