...
from FDAGAN.models.streamconfiguration import StreamConfiguration
from FDAGAN.tools.utils.filesio.persistence import mkdir, load_pickle_file
from FDAGAN.tools.utils.multimedia.video import extract_audio_from_video, get_video_fps, check_video_has_audio
from FDAGAN.tools.utils.multimedia.mediafiles import is_video_file
...
def parse_parts_str(parts_str):
    ...
    PART_IDS = StreamConfiguration.PART_IDS
