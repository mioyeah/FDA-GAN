from FDAGAN.models import ModelsFactory
from FDAGAN.tools.utils.signals.smooth import temporal_smooth_smpls
from FDAGAN.tools.utils.filesio.persistence import clear_dir
from FDAGAN.tools.utils.multimedia.video import fuse_src_ref_multi_outputs
from FDAGAN.services.preprocess import preprocess
from FDAGAN.services.personalization import personalize
from FDAGAN.services.options.process_info import ProcessInfo
from FDAGAN.services.options.meta_info import MetaImitateOutput
from FDAGAN.services.base_runner import (
...
def imitate(opt):
    ...
    if opt.ip:
        from FDAGAN.tools.utils.visualizers.visdom_visualizer import VisdomVisualizer
...
if __name__ == "__main__":
    from FDAGAN.services.options.options_inference import InferenceOptions

    OPT = InferenceOptions().parse()
    motiontransfer(opt=OPT)
